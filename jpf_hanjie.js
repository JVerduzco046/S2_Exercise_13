...
function init() {
      ...
      // insert html code for 1st puzzle table
      document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle1Hint, puzzle1Rating, puzzle1);
      // Add event handler for puzzle buttons 
      ...
      //  add an event listener 4 mouse up event 
      document.addEventListener("mouseup", endBackground);

      // add event listener to the show solution button 
      document.getElementById("solve").addEventListener("click", function () {
            //remove inline backgroundColor color from each cell
...
function swapPuzzle(e) {
      if (confirm("You will lose Progress Chief")) {
...
function setupPuzzle() {
      // amtch all data cells in puzzle
      ...
      for (var i = 0; i < puzzleCells.length; i++) {
            ...
            // use pencil img as cursor
            puzzleCells[i].style.cursor = "url(jpf_pencil.png),pointer"
      }
      // creat object collection of filled and empty cells
      ...
      // creat even listner to highlight incorrect cells;
...
function setBackground(e) {
      ...
      //set background based on keybored key we press
      if (e.shiftKey) {
      ...
      // creat event listener for every puzzle cell
      for (var i = 0; i < puzzleCells.length; i++) {
...
// create a function to extend the background and set the background to a new background color
...
function endBackground() {
      // remove event listener 4 every puzzle cell 
      for (var i = 0; i < puzzleCells.length; i++) {
